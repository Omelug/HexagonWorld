...
public class CLog {
  ...
  public void terror(String message) {
    error(message);
    System.exit(42);
  }
  ...
  public static void implErr() {
    implErr("");
  }
  public static void implErr(String message) {
    print(ConsoleColors.YELLOW, Thread.currentThread().getStackTrace()[2].getMethodName()+ ": " + message);
  }
